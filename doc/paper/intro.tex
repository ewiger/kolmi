...
Let \(M\) denote a language model and let \(x\) be a prompt or text sequence. We introduce semantic compression operators
\[
k : X \to X
\]
...
Importantly, this paper does not treat semantic compression as a single operation. Instead, we introduce an abstract family of semantic preservation utilities
\[
